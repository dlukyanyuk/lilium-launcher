...
public enum Servers {
	...
	CASSANDRA("http://client.lilium.su/cassandra/", "http://login.lilium.su/cassandra.php", 
			"/.lilium_cassandra/bin/minecraft.jar", "lilium_cassandra", "http://client.lilium.su/cassandra/md5.php?hash="), 
	CASSANDRAHDlow("http://client.lilium.su/cassandraHDlow/", "http://login.lilium.su/cassandra.php", 
			"/.lilium_cassandraHDlow/bin/minecraft.jar", "lilium_cassandraHDlow", "http://client.lilium.su/cassandraHDlow/md5.php?hash="), 
